    ...
    return (
        <>
            <Head>
                ...
                <Icons>
                    <a href="https://www.facebook.com/insight.iitbombay">
                        <i class="fa-brands fa-facebook-square"></i>
                    </a>
                    <a href="https://www.instagram.com/insight.iitb/">
                        <i class="fa-brands fa-instagram-square"></i>
                    </a>
                    <a href="https://www.linkedin.com/company/insight-iitb/mycompany/">
                        {' '}
            ...
            <NavigationBar>
                <Link to="/" activeClassName="active" className="route">
                    <div>Home</div>
                </Link>
